...
function AppointmentsPage() {
  ...
  const [selectedDentist, setSelectedDentist] = useState<SelectedDentist | null>(null);
  ...
  const handleSelectDentist = (dentist: SelectedDentist) => {
    ...
    bookAppointmentMutation.mutate(
      {
        ...
        doctorPhone: selectedDentist.phone,
        doctorSpeciality: selectedDentist.speciality,
        doctorImageUrl: selectedDentist.imageUrl,
        date: selectedDate,
        time: selectedTime,
